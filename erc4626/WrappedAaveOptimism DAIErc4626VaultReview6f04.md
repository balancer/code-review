...
# Rate Provider: WrappedAave Optimism DAI rate provider

## Details
This report was autogenerated on 12/05/2025.

- Deployed at:
    - [OP Mainnet:0x61b620FAd391b53A2D0973b10a3Ed69558d5c66E](https://optimistic.etherscan.io/address/0x61b620FAd391b53A2D0973b10a3Ed69558d5c66E)
- Audit report(s):
...
- [x] Other contracts which are part of the `mint` callchain are upgradeable**. You can find more information
   about the involved contracts in this [tenderly simulation](https://www.tdly.co/shared/simulation/cdfdcb9a-dee4-490c-b214-4a252d3460f1)
