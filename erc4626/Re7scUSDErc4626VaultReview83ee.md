...
- Deployed at:
    - [Sonic:0x592D1e187729C76EfacC6dfFB9355bd7BF47B2a7](https://sonicscan.org//address/0x592D1e187729C76EfacC6dfFB9355bd7BF47B2a7)
- Audit report(s):
...
- [ ] Other contracts which are part of the `mint` callchain are upgradeable**. You can find more information
   about the involved contracts in this [tenderly simulation](https://www.tdly.co/shared/simulation/c98f4042-b447-4441-8277-057ff5e87b4e)
