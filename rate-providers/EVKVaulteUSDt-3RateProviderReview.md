...
- Deployed at:
    - [Avalanche:0x4e7cE59ccBF84fA0C1d012Ae2F86f990d324A038](https://snowtrace.io/address/0x4e7cE59ccBF84fA0C1d012Ae2F86f990d324A038)
- Audit report(s):
...
- [x] Other contracts which are part of the `getRate` callchain are upgradeable**. You can find more information
   about the involved contracts in this [tenderly simulation](https://www.tdly.co/shared/simulation/01803749-8fb4-455e-baee-180deb7e5782)
